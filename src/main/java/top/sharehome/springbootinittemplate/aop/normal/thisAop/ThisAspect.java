package top.sharehome.springbootinittemplate.aop.normal.thisAop;
 ...
 * 示例：
 * "this(top.sharehome.springbootinittemplate.aop.normal.thisAop.service.ThisService)"
...
public class ThisAspect {
     ...
     * 定义切入点方法
     */
    @Pointcut("this(top.sharehome.springbootinittemplate.aop.normal.thisAop.service.ThisService)")
