 ...
 * 综上，该类型的一个完整示例如下：
 * "execution(public static final String *..aop.normal.executionAop..ExecutionService.* (..) throws Exception)"
 *
 * @author AntonyCheng
 */
@Component
...
public class ExecutionAspect {
     ...
     * 定义切入点方法
     */
    @Pointcut("execution(public * *..aop.normal.executionAop..ExecutionService.* (..))")
