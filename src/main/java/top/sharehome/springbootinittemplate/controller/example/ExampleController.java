...
//                    OpenAiChatEntity entity = new OpenAiChatEntity("o4-mini", "sk-1L8xfj2oMskTOOu3iUMeRw5u3h511UKE99keF7EHKSzRUSBQ", "https://api.chatanywhere.tech");
    ...
    public static void main(String[] args) throws IOException {
        String res1 = FileUtils.readFileToString(new File("D:/Desktop/spring-boot-init-template/res1.json"), StandardCharsets.UTF_8.name());
        String res2 = FileUtils.readFileToString(new File("D:/Desktop/spring-boot-init-template/res2.json"), StandardCharsets.UTF_8.name());
        String res3 = FileUtils.readFileToString(new File("D:/Desktop/spring-boot-init-template/res3.json"), StandardCharsets.UTF_8.name());
        List<DetailRes> detailRes1 = getDetailRes(res1);
        List<StraddleRes> straddleRes1 = getStraddleRes(res1);
        ExcelUtils.exportLocalFile(detailRes1, "违规条例表", DetailRes.class, "D:\\Desktop\\spring-boot-init-template\\detailRes1.xlsx");
        ExcelUtils.exportLocalFile(straddleRes1, "跨组违规表", StraddleRes.class, "D:\\Desktop\\spring-boot-init-template\\straddleRes1.xlsx");

        List<DetailRes> detailRes2 = getDetailRes(res2);
        List<StraddleRes> straddleRes2 = getStraddleRes(res2);
        ExcelUtils.exportLocalFile(detailRes2, "违规条例表", DetailRes.class, "D:\\Desktop\\spring-boot-init-template\\detailRes2.xlsx");
        ExcelUtils.exportLocalFile(straddleRes2, "跨组违规表", StraddleRes.class, "D:\\Desktop\\spring-boot-init-template\\straddleRes2.xlsx");

        List<DetailRes> detailRes3 = getDetailRes(res3);
        List<StraddleRes> straddleRes3 = getStraddleRes(res3);
        ExcelUtils.exportLocalFile(detailRes3, "违规条例表", DetailRes.class, "D:\\Desktop\\spring-boot-init-template\\detailRes3.xlsx");
        ExcelUtils.exportLocalFile(straddleRes3, "跨组违规表", StraddleRes.class, "D:\\Desktop\\spring-boot-init-template\\straddleRes3.xlsx");
    }
