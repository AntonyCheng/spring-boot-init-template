...
-- ----------------------------
INSERT INTO `t_log`
VALUES (1800928335635660801, '/api/auth/login', '用户登录', 0, 'POST',
        'top.sharehome.springbootinittemplate.controller.AuthController.login', 1900, '172.20.10.3',
        '0|0|0|内网IP|内网IP', '{\"account\":\"admin\"}', 0,
        '{\"msg\":\"登录成功\",\"code\":200,\"data\":{\"res\":{\"account\":\"admin\",\"id\":1900,\"name\":\"AntonyCheng\",\"role\":\"admin\"}}}',
        8914, '2024-06-13 00:29:10', '2024-06-13 00:29:10', 0);
INSERT INTO `t_log`
VALUES (1800928616662417409, '/api/auth/info', '用户获取个人信息', 3, 'GET',
        'top.sharehome.springbootinittemplate.controller.AuthController.info', 1900, '172.20.10.3',
        '0|0|0|内网IP|内网IP', '{}', 0,
        '{\"msg\":\"操作成功\",\"code\":200,\"data\":{\"account\":\"admin\",\"id\":1900,\"name\":\"AntonyCheng\",\"role\":\"admin\"}}',
        24, '2024-06-13 00:30:17', '2024-06-13 00:30:17', 0);
INSERT INTO `t_log`
VALUES (1800928690914181121, '/api/user/update/account', '用户更新自身账号', 4, 'PUT',
        'top.sharehome.springbootinittemplate.controller.user.UserController.updateAccount', 1900, '172.20.10.3',
        '0|0|0|内网IP|内网IP', '{\"newAccount\":\"admin\"}', 1,
        '{\"msg\":\"账号名称已经存在 ==> [不能和当前帐号重复]\",\"code\":11001,\"name\":\"USERNAME_ALREADY_EXISTS\"}',
        6, '2024-06-13 00:30:34', '2024-06-13 00:30:34', 0);
INSERT INTO `t_log`
VALUES (1800929054031855618, '/api/user/update/name', '用户更新自身名称', 4, 'PUT',
        'top.sharehome.springbootinittemplate.controller.user.UserController.updateName', 1900, '172.20.10.3',
        '0|0|0|内网IP|内网IP', '{\"newName\":\"AntonyCheng\"}', 1,
        '{\"msg\":\"账号名称已经存在 ==> [不能和当前名称重复]\",\"code\":11001,\"name\":\"USERNAME_ALREADY_EXISTS\"}',
        3, '2024-06-13 00:32:01', '2024-06-13 00:32:01', 0);
INSERT INTO `t_log`
VALUES (1800929095920369666, '/api/user/update/avatar', '用户更新自身头像', 4, 'PUT',
        'top.sharehome.springbootinittemplate.controller.user.UserController.updateAvatar', 1900, '172.20.10.3',
        '0|0|0|内网IP|内网IP', '{}', 1,
        '{\"exception\":\"java.lang.ExceptionInInitializerError\",\"method\":\"updateAvatar\",\"line\":285,\"class\":\"top.sharehome.springbootinittemplate.service.impl.UserServiceImpl\"}',
        36, '2024-06-13 00:32:11', '2024-06-13 00:32:11', 0);
INSERT INTO `t_log`
VALUES (1800929236089815042, '/api/admin/user/page', '管理员查询用户信息', 3, 'GET',
        'top.sharehome.springbootinittemplate.controller.user.AdminUserController.pageUser', 1900, '172.20.10.3',
        '0|0|0|内网IP|内网IP',
        '{\"allowDeep\":\"\",\"role\":\"\",\"size\":\"\",\"name\":\"\",\"page\":\"\",\"state\":\"\",\"account\":\"\"}',
        0,
        '{\"msg\":\"操作成功\",\"code\":200,\"data\":{\"current\":1,\"pages\":1,\"records\":[{\"account\":\"admin\",\"createTime\":\"2024-03-27 22:01:16\",\"id\":1900,\"name\":\"AntonyCheng\",\"role\":\"admin\",\"state\":0},{\"account\":\"user\",\"createTime\":\"2024-03-27 22:01:17\",\"id\":1901,\"name\":\"AntonyCoding\",\"role\":\"user\",\"state\":0},{\"account\":\"user1\",\"createTime\":\"2024-04-01 23:40:55\",\"id\":1902,\"name\":\"Antony1\",\"role\":\"user\",\"state\":0},{\"account\":\"user2\",\"createTime\":\"2024-04-01 23:40:55\",\"id\":1903,\"name\":\"Antony2\",\"role\":\"user\",\"state\":0},{\"account\":\"user3\",\"createTime\":\"2024-04-01 23:40:55\",\"id\":1904,\"name\":\"Antony3\",\"role\":\"user\",\"state\":0},{\"account\":\"user4\",\"createTime\":\"2024-04-01 23:40:55\",\"id\":1905,\"name\":\"Antony4\",\"role\":\"user\",\"state\":0},{\"account\":\"user5\",\"createTime\":\"2024-04-01 23:40:55\",\"id\":1906,\"name\":\"Antony5\",\"role\":\"user\",\"state\":0},{\"account\":\"user6\",\"createTime\":\"2024-04-01 23:40:55\",\"id\":1907,\"name\":\"Antony6\",\"role\":\"user\",\"state\":0},{\"account\":\"user7\",\"createTime\":\"2024-04-01 23:40:55\",\"id\":1908,\"name\":\"Antony7\",\"role\":\"user\",\"state\":0},{\"account\":\"user8\",\"createTime\":\"2024-04-01 23:40:55\",\"id\":1909,\"name\":\"Antony8\",\"role\":\"user\",\"state\":0},{\"account\":\"user9\",\"createTime\":\"2024-04-01 23:40:55\",\"id\":1910,\"name\":\"Antony9\",\"role\":\"user\",\"state\":0},{\"account\":\"user10\",\"createTime\":\"2024-04-02 18:51:27\",\"id\":1775113809426817025,\"name\":\"Antony10\",\"role\":\"user\",\"state\":0},{\"account\":\"user11\",\"createTime\":\"2024-04-02 18:58:13\",\"id\":1775115510955286530,\"name\":\"Antony11\",\"role\":\"user\",\"state\":0},{\"account\":\"user12\",\"createTime\":\"2024-04-02 20:17:22\",\"id\":1775135430363455490,\"name\":\"Antony12\",\"role\":\"user\",\"state\":0},{\"account\":\"user13\",\"createTime\":\"2024-04-02 20:54:08\",\"id\":1775144682826113025,\"name\":\"Antony13\",\"role\":\"user\",\"state\":0},{\"account\":\"user14\",\"createTime\":\"2024-04-02 20:56:28\",\"id\":1775145271509262337,\"name\":\"Antony14\",\"role\":\"user\",\"state\":0},{\"account\":\"user15\",\"createTime\":\"2024-04-02 20:59:35\",\"id\":1775146054472572929,\"name\":\"Antony15\",\"role\":\"user\",\"state\":0},{\"account\":\"user16\",\"...}',
        200, '2024-06-13 00:32:44', '2024-06-13 00:32:44', 0);
INSERT INTO `t_log`
VALUES (1800929447117832194, '/api/admin/user/page', '管理员查询用户信息', 3, 'GET',
        'top.sharehome.springbootinittemplate.controller.user.AdminUserController.pageUser', 1900, '172.20.10.3',
        '0|0|0|内网IP|内网IP',
        '{\"allowDeep\":\"\",\"role\":\"\",\"size\":\"10\",\"name\":\"\",\"page\":\"2\",\"state\":\"\",\"account\":\"\"}',
        0,
        '{\"msg\":\"操作成功\",\"code\":200,\"data\":{\"current\":2,\"pages\":4,\"records\":[{\"account\":\"user9\",\"createTime\":\"2024-04-01 23:40:55\",\"id\":1910,\"name\":\"Antony9\",\"role\":\"user\",\"state\":0},{\"account\":\"user10\",\"createTime\":\"2024-04-02 18:51:27\",\"id\":1775113809426817025,\"name\":\"Antony10\",\"role\":\"user\",\"state\":0},{\"account\":\"user11\",\"createTime\":\"2024-04-02 18:58:13\",\"id\":1775115510955286530,\"name\":\"Antony11\",\"role\":\"user\",\"state\":0},{\"account\":\"user12\",\"createTime\":\"2024-04-02 20:17:22\",\"id\":1775135430363455490,\"name\":\"Antony12\",\"role\":\"user\",\"state\":0},{\"account\":\"user13\",\"createTime\":\"2024-04-02 20:54:08\",\"id\":1775144682826113025,\"name\":\"Antony13\",\"role\":\"user\",\"state\":0},{\"account\":\"user14\",\"createTime\":\"2024-04-02 20:56:28\",\"id\":1775145271509262337,\"name\":\"Antony14\",\"role\":\"user\",\"state\":0},{\"account\":\"user15\",\"createTime\":\"2024-04-02 20:59:35\",\"id\":1775146054472572929,\"name\":\"Antony15\",\"role\":\"user\",\"state\":0},{\"account\":\"user16\",\"createTime\":\"2024-04-02 20:59:47\",\"id\":1775146105840214017,\"name\":\"Antony16\",\"role\":\"user\",\"state\":0},{\"account\":\"user17\",\"createTime\":\"2024-04-02 20:59:59\",\"id\":1775146158390648834,\"name\":\"Antony17\",\"role\":\"user\",\"state\":0},{\"account\":\"user18\",\"createTime\":\"2024-04-02 21:00:12\",\"id\":1775146210676842498,\"name\":\"Antony18\",\"role\":\"user\",\"state\":0}],\"size\":10,\"total\":33}}',
        42, '2024-06-13 00:33:35', '2024-06-13 00:33:35', 0);
INSERT INTO `t_log`
VALUES (1800929602185445378, '/api/admin/user/add', '管理员添加用户信息', 1, 'POST',
        'top.sharehome.springbootinittemplate.controller.user.AdminUserController.addUser', 1900, '172.20.10.3',
        '0|0|0|内网IP|内网IP', '{\"name\":\"Antony32\",\"account\":\"user32\"}', 0,
        '{\"msg\":\"添加成功\",\"code\":200}', 46, '2024-06-13 00:34:11', '2024-06-13 00:34:11', 0);
INSERT INTO `t_log`
VALUES (1800929644078153729, '/api/admin/user/add', '管理员添加用户信息', 1, 'POST',
        'top.sharehome.springbootinittemplate.controller.user.AdminUserController.addUser', 1900, '172.20.10.3',
        '0|0|0|内网IP|内网IP', '{\"name\":\"Antony32\",\"account\":\"user32\"}', 1,
        '{\"msg\":\"账号名称已经存在\",\"code\":11001,\"name\":\"USERNAME_ALREADY_EXISTS\"}', 13, '2024-06-13 00:34:21',
        '2024-06-13 00:34:21', 0);
INSERT INTO `t_log`
VALUES (1800929923221667841, '/api/admin/user/page', '管理员查询用户信息', 3, 'GET',
        'top.sharehome.springbootinittemplate.controller.user.AdminUserController.pageUser', 1900, '172.20.10.3',
        '0|0|0|内网IP|内网IP',
        '{\"allowDeep\":\"\",\"role\":\"\",\"size\":\"\",\"name\":\"\",\"page\":\"\",\"state\":\"\",\"account\":\"user32\"}',
        0,
        '{\"msg\":\"操作成功\",\"code\":200,\"data\":{\"current\":1,\"pages\":1,\"records\":[{\"account\":\"user32\",\"createTime\":\"2024-06-13 00:34:11\",\"id\":1800929601992507394,\"name\":\"Antony32\",\"role\":\"user\",\"state\":0}],\"size\":500,\"total\":1}}',
        55, '2024-06-13 00:35:28', '2024-06-13 00:35:28', 0);
INSERT INTO `t_log`
VALUES (1800930022186270721, '/api/admin/user/delete/1800929601992507394', '管理员删除用户信息', 2, 'DELETE',
        'top.sharehome.springbootinittemplate.controller.user.AdminUserController.deleteUser', 1900, '172.20.10.3',
        '0|0|0|内网IP|内网IP', '{}', 0, '{\"msg\":\"删除成功\",\"code\":200}', 98, '2024-06-13 00:35:52',
        '2024-06-13 00:35:52', 0);
INSERT INTO `t_log`
VALUES (1800930032965632001, '/api/admin/user/delete/1800929601992507394', '管理员删除用户信息', 2, 'DELETE',
        'top.sharehome.springbootinittemplate.controller.user.AdminUserController.deleteUser', 1900, '172.20.10.3',
        '0|0|0|内网IP|内网IP', '{}', 1,
        '{\"msg\":\"用户账户不存在\",\"code\":11006,\"name\":\"USER_ACCOUNT_DOES_NOT_EXIST\"}', 10,
        '2024-06-13 00:35:54', '2024-06-13 00:35:54', 0);
INSERT INTO `t_log`
VALUES (1800930086321373185, '/api/admin/user/export', '管理员导出用户表格', 6, 'GET',
        'top.sharehome.springbootinittemplate.controller.user.AdminUserController.exportExcel', 1900, '172.20.10.3',
        '0|0|0|内网IP|内网IP', '{}', 0, '{}', 2112, '2024-06-13 00:36:07', '2024-06-13 00:36:07', 0);
